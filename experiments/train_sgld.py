...
def run_sgld(train_loader, test_loader, net, likelihood, prior, samples_dir, 
             device=None, lr=1e-6, momentum=.9, temperature=1,
             burn_in=0, n_samples=20, epochs=1):
...
def main(seed=None, device=0, data_dir=None, augment=True, batch_size=128,
  ...
  run_sgld(train_loader, test_loader, net, likelihood, prior, samples_dir,
           device=device, lr=lr, momentum=momentum, temperature=temperature,
           burn_in=burn_in, n_samples=n_samples, epochs=epochs)
